...
static inline unsigned int rbavail( ring_buffer_t *rb ) {
	unsigned int r;
...
static inline unsigned int rbtail( ring_buffer_t *rb ) {
	unsigned int r;
...
static int      ring_buffer_peek( ring_buffer_t *rb, void *data, unsigned int data_len );
static int      ring_buffer_read( ring_buffer_t *rb, void *data, unsigned int data_len );
static int      ring_buffer_write( ring_buffer_t *rb, void *data, unsigned int data_len );
static int      ring_buffer_send( ring_buffer_t *out, ring_buffer_t *in, unsigned int data_len );
static int      ring_buffer_skip( ring_buffer_t *rb, unsigned int data_len );
static unsigned int ring_buffer_size( ring_buffer_t *rb );
static unsigned int ring_buffer_available( ring_buffer_t *rb );
static void     ring_buffer_reset( ring_buffer_t *rb );
static void     ring_buffer_realign( ring_buffer_t *rb );

int ring_buffer_init( ring_buffer_t *rb, unsigned int capacity, void *buffer ) {
	int r;
	...
	*( (unsigned int *) & rb->capacity ) = capacity;
	rb->head = 0;
	rb->len = 0;
...
static int ring_buffer_send( ring_buffer_t *out, ring_buffer_t *in, unsigned int data_len ) {
	...
	unsigned int orig_head_in;
	unsigned int orig_head_out;
